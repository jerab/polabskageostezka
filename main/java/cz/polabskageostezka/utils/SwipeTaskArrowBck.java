...
public class SwipeTaskArrowBck extends View {
    ...
    public SwipeTaskArrowBck(Context context) {
        super(context);
        mContext = context;
        init();
    }
    public SwipeTaskArrowBck(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        mContext = context;
        init();
    }
