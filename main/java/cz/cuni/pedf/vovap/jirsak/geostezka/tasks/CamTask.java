...
public class CamTask extends Task {
    String[] vysledky;
    int pocetCilu;
    public CamTask(int id, String label, String[] vysledky, String nazev, String zadani, String uri, int retez) {
        super(id, label, Config.TYP_ULOHY_CAM, nazev, zadani, uri, retez);
