...
package cz.cuni.pedf.vovap.jirsak.geostezka.utils.ar_support;
...
public class ArVuforiaApplicationSession implements UpdateCallbackInterface
{
    ...
    private ArVuforiaApplicationControl mSessionControl;
    ...
    public ArVuforiaApplicationSession(ArVuforiaApplicationControl sessionControl)
    {
    ...
    {
        ArVuforiaApplicationException vuforiaException = null;
        mActivity = activity;
        ...
        // ArVuforiaApplicationSession needs to update the Projection Matrix.
        ...
        if (mInitVuforiaTask != null)
        {
            ...
            vuforiaException = new ArVuforiaApplicationException(
                ArVuforiaApplicationException.VUFORIA_ALREADY_INITIALIZATED,
                logMessage);
        ...
        if (vuforiaException == null)
        {
            ...
            } catch (Exception e)
            {
                ...
                vuforiaException = new ArVuforiaApplicationException(
                    ArVuforiaApplicationException.INITIALIZATION_FAILURE,
                    logMessage);
                Log.e(LOGTAG, logMessage);
            }
        }
    ...
    public void startAR(int camera) throws ArVuforiaApplicationException
    {
        String error;
        if(mCameraRunning)
        {
        	...
        	Log.e(LOGTAG, error);
            throw new ArVuforiaApplicationException(
                ArVuforiaApplicationException.CAMERA_INITIALIZATION_FAILURE, error);
        }
    ...
    public void stopAR() throws ArVuforiaApplicationException
    {
        ...
        synchronized (mShutdownLock)
        {
            ...
            if (!unloadTrackersResult)
                throw new ArVuforiaApplicationException(
                    ArVuforiaApplicationException.UNLOADING_TRACKERS_FAILURE,
                    "Failed to unload trackers\' data");
            
            if (!deinitTrackersResult)
                throw new ArVuforiaApplicationException(
                    ArVuforiaApplicationException.TRACKERS_DEINITIALIZATION_FAILURE,
    ...
    public void resumeAR() throws ArVuforiaApplicationException
    {
    ...
    public void pauseAR() throws ArVuforiaApplicationException
    {
        if (mStarted)
        {
            stopCamera();
    ...
    private class InitVuforiaTask extends AsyncTask<Void, Integer, Boolean>
    {
        ...
        protected Boolean doInBackground(Void... params)
        {
            ...
            synchronized (mShutdownLock)
            {
                Vuforia.setInitParameters(mActivity, mVuforiaFlags,  mActivity.getResources().getString(R.string.VUFORIA_API_KEY));
            ...
            if (result)
            {
                ...
                if (initTrackersResult)
                {
                    ...
                    } catch (Exception e)
                    {
                        ...
                        vuforiaException = new ArVuforiaApplicationException(
                            ArVuforiaApplicationException.LOADING_TRACKERS_FAILURE,
                            logMessage);
                        Log.e(LOGTAG, logMessage);
                        mSessionControl.onInitARDone(vuforiaException);
                    }
                ...
                {
                    vuforiaException = new ArVuforiaApplicationException(
                        ArVuforiaApplicationException.TRACKERS_INITIALIZATION_FAILURE,
    ...
    private class LoadTrackerTask extends AsyncTask<Void, Integer, Boolean>
    {
        ...
        protected void onPostExecute(Boolean result)
        {
            ...
            } else
            {
                ...
                Vuforia.registerCallback(ArVuforiaApplicationSession.this);
