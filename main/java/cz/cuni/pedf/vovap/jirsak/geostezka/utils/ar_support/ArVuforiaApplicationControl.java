...
//  Interface to be implemented by the activity which uses ArVuforiaApplicationSession
public interface ArVuforiaApplicationControl
{
    ...
    void onInitARDone(ArVuforiaApplicationException e);
