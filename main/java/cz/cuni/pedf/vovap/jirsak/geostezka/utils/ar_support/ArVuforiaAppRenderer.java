...
import cz.cuni.pedf.vovap.jirsak.geostezka.utils.ar_utils.SampleUtils;
import cz.cuni.pedf.vovap.jirsak.geostezka.utils.ar_utils.VideoBackgroundShader;

//import cz.cuni.pedf.vovap.jirsak.geostezka.utils.SampleUtils;
//import cz.cuni.pedf.vovap.jirsak.geostezka.utils.VideoBackgroundShader;

public class ArVuforiaAppRenderer {

    private static final String LOGTAG = "ArVuforiaAppRenderer";

    private RenderingPrimitives mRenderingPrimitives = null;
    private ArVuforiaAppRendererControl mRenderingInterface = null;
    ...
    public ArVuforiaAppRenderer(ArVuforiaAppRendererControl renderingInterface, Activity activity, int deviceMode,
    ...
    public void render()
    {
        ...
        for (int v = 0; v < viewList.getNumViews(); v++)
        {
            ...
            // Call renderFrame from the app renderer class which implements ArVuforiaAppRendererControl
